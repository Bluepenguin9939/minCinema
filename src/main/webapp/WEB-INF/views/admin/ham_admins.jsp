...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<div
		class="d-sm-flex align-items-center justify-content-between mb-4 mana">
		<label class="h3 mb-0 text-black-800" id="mainManage">관리자 메인
			페이지</label>
	</div>
</div>
...
<div class="col-md-12">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="chartBox">
				<h3 class="d-flex justify-content-center">
					<span class="material-symbols-outlined">movie</span>장르별 등록 영화수
				</h3>
				<div>
		...
		<div class="col-md-6">
			<h3 class="d-flex justify-content-center">
				<i class="fa fa-headset"></i>고객 문의사항 답변
			</h3>
			<div>
...
<div class="col-md-12">
	<div class="row">
		<div class="col-md-6">
			<h3 class="" id="ageView">
				<span class="material-symbols-outlined">family_restroom</span>연령별 회원
				수
			</h3>
			<div class="d-flex justify-content-center"
				style="width: 80%; height: 80%; resize: none;">
				<canvas id="myChart3"></canvas>
			</div>
		</div>
		<!-- 선형 차트-매출액 -->
		<div class="col-md-6">
			<h3 class="d-flex justify-content-center" id="monthPoint">
