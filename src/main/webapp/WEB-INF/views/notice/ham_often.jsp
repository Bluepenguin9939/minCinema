		...
		<div class="col-md-12">
			...
			<!-- Q1 -->
				<div class="card">
					...
					<div id="card-element-397258" class="collapse show">
						<div class="card-body">
			...
			<!-- Q2 -->
				<div class="card">
					...
					<div id="card-element-660485" class="collapse show">
						<div class="card-body">
			...
			<!-- Q3 -->
				<div class="card">
					...
					<div id="card-element-000000" class="collapse show">
						<div class="card-body">
			...
			<!-- Q4 -->
				<div class="card">
					...
					<div id="card-element-000001" class="collapse show">
						<div class="card-body">
							<label>로그인 후 본인 프로플 클릭 후 마이페이지 이동시 좌측에 보유 포인트 및 보유 쿠폰 개수를 확인할 수 있습니다.</label>
						</div>
					</div>
				</div>
			<!-- Q5 -->
				<div class="card">
					...
					<div id="card-element-000002" class="collapse show">
						<div class="card-body">
							<label>로그인 후 본인 프로플 클릭 후 마이페이지 이동 후 이용내역을 확인하실 수 있습니다.</label>
						</div>
					</div>
				</div>
